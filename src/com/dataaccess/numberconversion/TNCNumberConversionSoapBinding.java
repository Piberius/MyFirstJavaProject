...
public class TNCNumberConversionSoapBinding
{
    ...
    public TNCNumberConversionSoapBinding()
    {
    }

    public TNCNumberConversionSoapBinding(String url)
    {
        this.url=url;
    }

    public TNCNumberConversionSoapBinding (String url,TNCConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        TNCRequestResultHandler handler = new TNCRequestResultHandler(TNCSoapVersion.v1_1);
        return handler;
    }
